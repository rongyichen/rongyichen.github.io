...
const AcademicProfile = () => {
  ...
  const content = {
    en: {
      ...
      profile: {
        ...
        awards: [
          { icon: "🏆", title: "National Scholarship", org: "Ministry of Education of China, 2025" },
          { icon: "🎖️", title: "First Class Academic Scholarship & Mittal Scholarship", org: "Central South University, 2025" },
          { icon: "🏆", title: "First Prize for Outstanding Radio and Television Programs", org: "Hunan Province Radio and Television Association, 2025 & 2024" },
          { icon: "🎖️", title: "Best Paper Award & Outstanding Graduate Student", org: "School of Humanities, Central South University, 2024" },
          { icon: "🏆", title: "Outstanding Graduation Thesis Award", org: "Communication University of China, 2023" },
    ...
    zh: {
      ...
      profile: {
        ...
        awards: [
          { icon: "🏆", title: "国家奖学金", org: "中华人民共和国教育部, 2025" },
          { icon: "🎖️", title: "一等学业奖学金 & 米塔尔奖学金", org: "中南大学, 2025" },
          { icon: "🏆", title: "优秀广播电视作品一等奖", org: "湖南省广播电视协会, 2025 & 2024" },
          { icon: "🎖️", title: "最佳论文奖 & 优秀研究生", org: "中南大学人文学院, 2024" },
          { icon: "🏆", title: "优秀毕业论文奖", org: "中国传媒大学, 2023" },
          { icon: "🎖️", title: "最佳摄影奖", org: "河北广播电视台, 2022" }
        ]
      },
  ...
  const newsData = {
    academic: [
      { date: "2025-12-24", title: "🎓 Admitted to Peking University Ph.D. Program!", titleZh: "🎓 北京大学博士预录取！", content: "Received pre-admission to the Ph.D. program in Communication Studies at the School of Journalism and Communication, Peking University, focusing on Big Data & AI Marketing Communication. Starting September 2026.", contentZh: "获北京大学新闻与传播学院传播学博士项目预录取，研究方向为大数据与人工智能营销传播，将于2026年9月入学。" },
      { date: "2025-09-10", title: "📄 Paper Published in Cultural Trends!", titleZh: "📄 论文发表于Cultural Trends！", content: "Published co-authored paper 'Artists and Their Poor: Economic and Symbolic Inequality in Distorted China's Post-Pandemic Art Subsidy Policies' in Cultural Trends.", contentZh: "合作论文《艺术家及其贫困：中国后疫情时代艺术补贴政策中的经济与符号不平等》发表于Cultural Trends。" },
      { date: "2025-06-20", title: "🎉 Paper Accepted by IJHCI!", titleZh: "🎉 论文被IJHCI录用！", content: "Accepted co-authored paper 'Enhancing Trust or Fostering Misjudgment? Assessing the Impact of Emerging Geographic Information Displays on Social Media Users' Information Trust' to the International Journal of Human–Computer Interaction.", contentZh: "合作论文《增强信任还是助长误判？社交媒体地理信息展示对用户信息信任的影响》被《国际人机交互期刊》录用。" },
      { date: "2025-05-20", title: "🏆 Received AEJMC Second Place Paper Award!", titleZh: "🏆 获AEJMC论文二等奖！", content: "Received Second Place Faculty Paper Award at the Mass Communication and Society Division, AEJMC 2025 108th Annual Conference. Presented at the MCS Top Refereed Research Paper Session as first author.", contentZh: "在第108届AEJMC年会大众传播与社会分会获论文二等奖，作为第一作者在MCS顶级论文报告环节进行汇报。" },
      { date: "2025-03-13", title: "📧 Accepted 4 Conference Papers!", titleZh: "📧 4篇会议论文录用！", content: "Accepted four co-authored papers to international communication conferences: two papers to ICA Annual Conference and Pre-Conference as first author, one to IAMCR Annual Conference as second author, and one to ICA Annual Conference as third author.", contentZh: "四篇合作论文被国际传播学会议录用：两篇以第一作者身份被ICA年会及前会录用，一篇以第二作者被IAMCR年会录用，一篇以第三作者被ICA年会录用。" }
    ],
    industry: [
      { date: "2025-06-19", title: "🤖 Deployed AI Robot System in Chinese Restaurant!", titleZh: "🤖 《中餐厅》AI机器人系统上线！", content: "Developed and deployed multi-modal AI robot system for Mango TV's 'Chinese Restaurant: African Entrepreneurship Season', integrating large language models with mechanical control for multilingual voice interaction and real-time visual processing.", contentZh: "为芒果TV《中餐厅·非洲创业季》开发部署多模态AI机器人系统，集成大语言模型与机械控制，实现多语言语音交互和实时视觉处理。" },
      { date: "2025-05-30", title: "🏆 Won Hunan Outstanding Radio & TV Program Award!", titleZh: "🏆 获湖南省优秀广播电视作品奖！", content: "Honored with First Prize for Outstanding Radio and Television Programs by Hunan Province Radio and Television Association for the second time as sole author.", contentZh: "第二次以独立作者身份获得湖南省广播电视协会优秀广播电视作品一等奖。" },
      { date: "2025-05-16", title: "🎤 Launched AI Virtual Audience in Singer 2025!", titleZh: "🎤 《歌手2025》AI虚拟观众系统上线！", content: "Co-designed and deployed AI-powered 'Virtual Audience' features for 'Singer 2025' live broadcast, enabling real-time facial expression analysis and emoji visualization for 500+ audience members.", contentZh: "为《歌手2025》直播联合设计并部署AI虚拟观众系统，实现500+观众的实时面部表情分析和表情可视化。" },
      { date: "2025-05-15", title: "🎧 Deployed Interactive AI System for Ride the Wind!", titleZh: "🎧 《乘风破浪》AI交互系统上线！", content: "Led design and deployment of advanced AI interaction system for 'Sisters Who Make Life Better', featuring celebrity personality simulation with reduced latency for production environments.", contentZh: "主导设计并部署《乘风2025·姐姐的美好生活》AI交互系统，实现低延迟明星人格模拟。" },
      { date: "2025-05-14", title: "😊 Launched AI Comedy Evaluation System!", titleZh: "😊 AI喜剧评分系统上线！", content: "Co-developed and launched AI-powered comedy scoring system utilizing real-time facial expression analysis, debuted on Mango TV's 'Ha Ha No Worries'.", contentZh: "联合开发并上线基于实时面部表情分析的AI喜剧评分系统，在芒果TV《哈哈哈哈哈》首播。" }
    ]
  };

  const featuredResearch = [
    { year: "2025", title: "Enhancing Trust or Fostering Misjudgment? Assessing the Impact of Emerging Geographic Information Displays on Social Media Users’ Information Trust", titleZh: "增强信任还是助长误判？新兴地理信息显示功能对社交媒体用户信息信任的影响评估", venue: "International Journal of Human–Computer Interaction (IJHCI)", authors: "Yalong Xiao, Rongyi Chen, Qing Xiao, Chengzhang Zhu, Jie Feng", link: "https://doi.org/10.1080/10447318.2025.2524493" },
    { year: "2025", title: "Artists and their poor: economic and symbolic inequality in distorted China's post-pandemic art subsidy policies", titleZh: "艺术家及其贫困者：后疫情时代中国艺术补贴政策中的经济与符号不平等", venue: "Cultural Trends", authors: "Jingjia Xiao, Qing Xiao, Rongyi Chen", link: "https://doi.org/10.1080/09548963.2025.2557215" },
  ...
  const experienceData = [
    ...
    { period: "2021", title: "Live-streaming Tech Specialist Intern", titleZh: "直播技术专员实习生", org: "Alibaba Entertainment, Youku/Laifeng", orgZh: "阿里大文娱 优酷/来疯", desc: "Testing digital humans and interactive gaming features for live streaming products.", descZh: "测试数字人及直播互动游戏功能。", logo: "/images/logos/alibaba.jpeg" },
    ...
    { period: "2020 - 2021", title: "Journalist Intern", titleZh: "记者实习生", org: "Zhanjiang Radio and Television", orgZh: "湛江广播电视台", desc: "Produced news segments and documentary content for local television broadcasts.", descZh: "制作本地电视新闻片段和纪录片内容。", logo: "/images/logos/zhanjiang.jpeg" }
  ];
